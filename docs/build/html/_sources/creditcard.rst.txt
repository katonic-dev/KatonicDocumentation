...
The dataset involved here is publicly available at `CreditCard Dataset <https://www.kaggle.com/toramky/automobile-dataset>`_ that predict the price of the automobiles given all the information in the dataset. 
...
Visualization of CreditCard Data preprocessing Components

.. figure:: /images/prepro_vis.png
   :scale: 40%
   :align: center

Visualization of CreditCard Feature engineering Components
